...
import { Search, TrendingUp, Sparkles, X, Loader2, Trophy, UserPlus, MapPin, Video, Dumbbell, Heart, Palette, GraduationCap } from 'lucide-react';
      ...
      <form onSubmit={handleSearch} className="flex items-center gap-3">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full h-12 pl-14 pr-10 rounded-xl bg-input border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
          />
        ...
        <button 
          ...
          className="h-12 w-12 rounded-xl bg-primary text-primary-foreground flex items-center justify-center disabled:opacity-50 hover:bg-primary/90 transition-all duration-300 active:scale-[0.97]"
        >
          {isLoading ? (
