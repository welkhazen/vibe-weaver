...
const navItems: NavItem[] = [
  ...
  { id: "tcm", label: "", icon: <video autoPlay loop muted playsInline className="w-9 h-9" style={{ background: 'transparent' }}><source src="/assets/brain-logo.webm" type="video/webm" /></video>, useThemeColor: true },
